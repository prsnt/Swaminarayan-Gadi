class LocationFilterModel {
  ...
  LocationFilterModel.fromJson(Map<String, dynamic> json)
      : isError = json['isError'] as bool?,
        ...
        data = (json['data'] as List?)?.map((dynamic e) => LocationFilterData.fromJson(e as Map<String, dynamic>)).toList();
  final bool? isError;
  final String? message;
  final List<LocationFilterData>? data;
...
class LocationFilterData {
  ...
  LocationFilterData.fromJson(Map<String, dynamic> json)
